...
<div class="modal fade" id="mailModal" tabindex="-1" aria-labelledby="mailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mailModalLabel">Send Message</h5>
            ...
            <div class="modal-body">
                <form id="mailForm">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="recipient" name="mail_type" required>
                            <option value="">Select student</option>
                            <?php
                            try {
                                $stmt = $koneksi->prepare("SELECT id, nim, nama_lengkap FROM mahasiswa ORDER BY nama_lengkap");
                                $stmt->execute();
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    echo "<option value='" . $row['id'] . "'>" . htmlspecialchars($row['nim'] . ' - ' . $row['nama_lengkap']) . "</option>";
                                }
                            } catch(PDOException $e) {
